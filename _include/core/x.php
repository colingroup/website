...
class Moderator {
    ...
    static function checkAccess($return = false)
    {
        ...
        foreach (self::$sections as $section) {
            if ($g_user['moderator_' . $section] == 1) {
                $default = $section;
                break;
            }
        }
...
class IP {
    ...
    static function block()
    {
        ...
        if(get_session('ip_block_check_time') > Common::getOption('last_update_time', 'ipblock')) {
            return;
        }
        ...
        set_session('ip_block_check_time', time());
    }
...
class Config {
    ...
    static function all()
    {
        ...
        if (Common::isIosDevice()) {
            if (Common::isAppIos() || !Common::isSafari()) {
