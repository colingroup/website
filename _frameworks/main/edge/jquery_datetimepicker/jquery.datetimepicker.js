...
(function( $ ) {
	...
	$.fn.date_time_picker = function( opt ) {
		var KEY0 = 48,
			KEY9 = 57,
			_KEY0 = 96,
			_KEY9 = 105,
			...
			createDateTimePicker = function( input ) {
                ...
                if (options.sel && options.sel[0]) {
                    options.sel.append(datetimepicker);
                }else{
				...
				var setPos = function() {
                    ...
                    var d=window.innerHeight-$('#event_time')[0].getBoundingClientRect().bottom,
                        h=datetimepicker[0].offsetHeight+3,
                        css={
                            left:left,
                            top:'44px',
                            position: position
                    ...
                    //console.log('datetimepicker css:', d, h, css.top);
				...
				datetimepicker
					.on('open.xdsoft', function() {
						...
						if( onShow!==false ) {
                            if (options.fnAnimateIn) {
                                datetimepicker[options.fnAnimateIn](options.fnAnimateDelay||200);
                            } else {
                                datetimepicker.show();
                            }

							setPos();
							$win.off('resize.xdsoft',setPos)
					...
					.on('close.xdsoft', function( event ) {
						...
						if( onClose!==false&&!options.opened&&!options.inline ) {
                            if (options.fnAnimateOut) {
                                datetimepicker[options.fnAnimateOut](options.fnAnimateDelay||200);
                            }else{
                                datetimepicker.hide();
                            }
						}
	...
	$.fn.date_time_picker.defaults = default_options;
})( jQuery );
